...
export const translations = {
    ...
    // QR Codes Page
    qrManagementTitle: 'QR Code Management',
    addTableRoom: 'Add New Table/Room',
    tableNumber: 'Table/Room Number',
    isRoom: 'This is a Room',
    location: 'Location',
    addTableButton: 'Add Table/Room',
    manageQRCodes: 'Manage QR Codes',
    noTables: 'No tables/rooms added yet.',
    printSelectedQRCodes: 'Print Selected QR Codes',
    viewQR: 'View',
    tableTypeRoom: 'Room',
    ...
    // QR Codes Page
    qrManagementTitle: 'Usimamizi wa QR Code',
    addTableRoom: 'Ongeza Meza/Chumba Mpya',
    tableNumber: 'Nambari ya Meza/Chumba',
    isRoom: 'Hili ni Chumba',
    location: 'Mahali',
    addTableButton: 'Ongeza Meza/Chumba',
    manageQRCodes: 'Simamia Msimbo wa QR',
    noTables: 'Hakuna meza/vyumba vilivyoongezwa bado.',
    printSelectedQRCodes: 'Chapisha Msimbo wa QR Uliochaguliwa',
    viewQR: 'Ona',
    tableTypeRoom: 'Chumba',
    tableTypeTable: 'Meza',
    // Reports Page
    salesReports: 'Ripoti za Mauzo',
    filterReports: 'Chuja Ripoti',
    from: 'Kutoka',
    to: 'Hadi',
    filter: 'Chuja',
    clearFilter: 'Tafuta Tena',
    ordersByStatus: 'Maagizo kwa Hali',
    ...
    // QR Codes Page
    qrManagementTitle: 'Gestion des Codes QR',
    addTableRoom: 'Ajouter une Table/Salle',
    tableNumber: 'Numéro de Table/Salle',
    isRoom: 'Ceci est une Salle',
    location: 'Emplacement',
    addTableButton: 'Ajouter Table/Salle',
    manageQRCodes: 'Gérer les Codes QR',
    noTables: 'Aucune table/salle ajoutée pour l\'instant.',
    printSelectedQRCodes: 'Imprimer les Codes QR Sélectionnés',
    viewQR: 'Voir',
    tableTypeRoom: 'Salle',
    tableTypeTable: 'Table',
    // Reports Page
